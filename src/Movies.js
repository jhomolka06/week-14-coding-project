...
const Movies = () => {
  const moviesData = [
    ...
    //movie data
    {
      ...
      paragraph: 'A New York reporter named Sue Charlton heads to Australia to interview the living legend, known as "Crocodile" Dundee. When she finally finds him in the vast Australian terrain, she is so enthralled with him that she brings him back with her to New York City. In New York, Dundee is amazed by the many wonders of the city life and the interesting people there. Its a whole new way of life for the crocodile hunting adventurer.',
    },
    // movie data
    {
    title: 'Forrest Gump',
